...
public class ServerApplication {
	...
	CommandLineRunner run(ServerRepo serverRepo) {
		...
		return args -> {
			serverRepo.save(new Server(null, "192.168.1.167", "Ubuntu Linux", "16 GB", "Personal PC",
					"http://localhost:8080/server/images/server1.png", Status.SERVER_UP));
			serverRepo.save(new Server(null, "192.168.1.165", "Ubuntu RedHat", "32 GB", "Private PC",
